...
void test_connection_controller_init_fail_TCP_connection(void) {
   // TEST_ASSERT_EQUAL(1, 0);
    wifi_command_join_AP_fake.return_val = WIFI_OK;
...
void test_connection_controller_init_success_AP(void) {
    wifi_command_join_AP_fake.return_val = WIFI_OK;
    wifi_command_create_TCP_connection_fake.return_val = WIFI_FAIL;
    bool result = connection_controller_init();
...
void test_connection_controller_init_fail_AP(void) {
    //TEST_ASSERT_EQUAL(1, 0);
...
void test_connection_controller_init_success_AP_and_success_server(void) {
    wifi_command_join_AP_fake.return_val = WIFI_OK;
    wifi_command_create_TCP_connection_fake.return_val = WIFI_OK;
    bool result = connection_controller_init();
...
void test_connection_controller_transmit_success(void) {
    //TEST_ASSERT_EQUAL(1, 0);
    wifi_command_TCP_transmit_fake.return_val = WIFI_OK;

    Package package = { .data = "T=22.5/H=30/L=600", .size = strlen(package.data) };
    bool result = connection_controller_transmit(package);

    TEST_ASSERT_TRUE(result);
}

void test_connection_controller_transmit_fail(void) {
    //TEST_ASSERT_EQUAL(1, 0);
...
void test_connection_controller_send_message_fail(void) {
    //TEST_ASSERT_EQUAL(1, 0);
    wifi_command_TCP_transmit_fake.return_val = WIFI_FAIL;

    char message[] = "FAIL";
    bool result = connection_controller_send_message(message);

    TEST_ASSERT_FALSE(result);
}

void test_connection_controller_send_message_success(void) {
    //TEST_ASSERT_EQUAL(1, 0);
    wifi_command_TCP_transmit_fake.return_val = WIFI_OK;
...
int main(void) {
    ...
    RUN_TEST(test_connection_controller_init_success_AP);
    RUN_TEST(test_connection_controller_init_fail_AP);
    RUN_TEST(test_connection_controller_init_fail_TCP_connection);
    RUN_TEST(test_connection_controller_transmit_success);
    RUN_TEST(test_connection_controller_transmit_fail);
    RUN_TEST(test_connection_controller_send_message_success);
    RUN_TEST(test_connection_controller_send_message_fail);
